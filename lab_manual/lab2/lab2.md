...
-   Check the persistence box on the scope and reduce the alpha to
...
-   Open the GRC patch [ra5.grc](data/ra5.grc). This flowgraph
...
-   Review the theory on [section 1.4 Spectrum
